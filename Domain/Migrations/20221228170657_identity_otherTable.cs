...
{
    public partial class identity_otherTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MealCategoryID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MealCategoryName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MealCategoryImage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealCategorys", x => x.MealCategoryID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK_TableOrders_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrcessStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
